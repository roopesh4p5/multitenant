// Generated BY AI which i still not sure if it is correct or not
...
export const validateEmployeeData = async (
  ...
  // TEMP: skip schema validation per request — allow all values for now
  // Remove this short-circuit when schema validation should be enforced again.
